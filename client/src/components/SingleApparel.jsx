				...
				<div style={{ marginTop: '10px', marginBottom: '40px' }}>
					<Card className="container" style={{ width: '31rem', marginBottom: '40px' }}>
						<Card>
							...
							<Card.Body>
								<Card.Title className="product-title">{this.state.apparel.name}</Card.Title>
								<Card.Title className="product-title">{this.state.apparel.description}</Card.Title>
								<Card.Title className="product-title">${this.state.apparel.price}.00</Card.Title>
							</Card.Body>
							...
							<Container style={{ textAlign: 'center', marginBottom: '30px', marginTop: '8px' }}>
								<button className="edit-apparel-button"
